...
public class IPAddressUtil {
      ...
      if (var0.length() < 2) {
         ...
         if (var8 == var7 - 1) {
            ...
            while(true) {
               ...
               while(var9 < var7) {
                  char var2 = var5[var9++];
                  var12 = Character.digit((char)var2, 16);
                  if (var12 != -1) {
                     var4 <<= 4;
                     var4 |= var12;
                     if (var4 > 65535) {
   ...
   public static String checkExternalForm(URL var0) {
      if (var0 == null) {
         ...
         String var1;
         int var2 = scan(var1 = var0.getUserInfo(), 140741783322623L, Long.MIN_VALUE);
         if (var2 >= 0) {
   ...
   public static String checkHostString(String var0) {
      if (var0 == null) {
         ...
         int var1 = scan(var0, 140741783322623L, Long.MIN_VALUE, OTHERS);
         return var1 >= 0 ? "Illegal character found in host: " + describeChar(var0.charAt(var1)) : null;
      }
   }
}
