...
public class PKCS7_1 {
     ...
     */
    public PKCS7_1(InputStream in) throws ParsingException, IOException {
     ...
     * @exception ParsingException on parsing errors.
     */
    public PKCS7_1(DerInputStream derin) throws ParsingException {
        parse(derin);
    }
     ...
     * @exception ParsingException on parsing errors.
     */
    public PKCS7_1(byte[] bytes) throws ParsingException {
        try {
     ...
     */
    public PKCS7_1(AlgorithmId[] digestAlgorithmIds,
        ...
        throws CertificateException, IOException, NoSuchAlgorithmException
    {
        ...
        PKCS7_1 pkcs7 = new PKCS7_1(algorithms, contentInfo,
        ...
        throws IOException, CertificateException
    {
        ...
        PKCS7_1 tsToken = tsReply.getToken();
