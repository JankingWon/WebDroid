...
public class SignerInfo implements DerEncoder {
     ...
     */
    public X509Certificate getCertificate(PKCS7_1 block)
        throws IOException
    {
     ...
     */
    public ArrayList<X509Certificate> getCertificateChain(PKCS7_1 block)
        throws IOException
    {
    ...
    /* Returns null if verify fails, this signerInfo if
       verify succeeds. */
    SignerInfo verify(PKCS7_1 block, byte[] data)
    ...
    SignerInfo verify(PKCS7_1 block)
    throws NoSuchAlgorithmException, SignatureException {
               ...
               CertificateException
    {
        ...
        PKCS7_1 tsToken = new PKCS7_1((byte[])tsTokenAttr.getValue());
