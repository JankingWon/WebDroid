...
public class XmlEditor {
	 ...
	 * 没有"android:"前缀的属性
	 */
	public static String[] attributesHasNoPrefix = new String[]{"package"};
	 ...
	 * @param name
	 */
	public static void removeTag(String tagName, String name) throws UnsupportedEncodingException {
	 ...
	 * 添加标签内容 
	 */
	public static void addTag(String insertXml)throws UnsupportedEncodingException{
		ParserChunkUtils.parserXml();
		try {
	 ...
	 * @param attrName
	 */
	public static void removeAttr(String tag, String tagName, String attrName)throws UnsupportedEncodingException{
		ParserChunkUtils.parserXml();
...
//		XmlEditor.addAttr(tag, tagName, attrName, attrValue);
	 ...
	 * @param attrValue
	 */
	public static void addAttr(String tag, String tagName, String attrName, String attrValue)throws UnsupportedEncodingException{
		ParserChunkUtils.parserXml();
		//构造一个属性出来
		int[] type = getAttrType(attrValue);
		int attrname = getStrIndex(attrName);
		int attrvalue = getStrIndex(attrValue);
		int attruri = hasPrefix(attrName) ? getStrIndex(prefixStr) :-1;
	...
	/**
	 * 判断是否是含有"andorid:"前缀的属性
	 * @param tagName
	 * @return
	 */
	public static boolean hasPrefix(String tagName){
		for(String str : attributesHasNoPrefix){
			if(str.equals(tagName)){
				return false;
			}
		}
